pipeline {
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', credentialsId: 'your-credentials-id', url: 'https://github.com/VC1717/my-jenkins-pipeline.git'
            }
        }
        ...
        stage('Stage 2: Unit and Integration Tests') {
            ...
            post {
                success {
                    emailext attachLog: true, body: "Stage 2: Unit and Integration Tests passed successfully.", subject: "Pipeline Notification: Stage 2 Passed", to: "vidhic1790@gmail.com"
                }
                failure {
                    emailext attachLog: true, body: "Stage 2: Unit and Integration Tests failed. Please check the logs for details.", subject: "Pipeline Notification: Stage 2 Failed", to: "vidhic1790@gmail.com"
                }
            }
        }
        ...
        stage('Stage 4: Security Scan') {
            ...
            post {
                success {
                    emailext attachLog: true, body: "Stage 4: Security Scan passed successfully.", subject: "Pipeline Notification: Stage 4 Passed", to: "vidhic1790@gmail.com"
                }
                failure {
                    emailext attachLog: true, body: "Stage 4: Security Scan failed. Please check the logs for details.", subject: "Pipeline Notification: Stage 4 Failed", to: "vidhic1790@gmail.com"
                }
            }
        }
